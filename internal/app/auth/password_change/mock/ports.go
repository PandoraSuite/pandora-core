...
// Source: internal/app/auth/password_change/ports.go
//
// Generated by this command:
//
//	mockgen -source=internal/app/auth/password_change/ports.go -destination=internal/app/auth/password_change/mock/ports.go -package=mock
//
...
func (m *MockCredentialsRepository) ChangePassword(ctx context.Context, credentials *entities.Credentials) errors.Error {
	m.ctrl.T.Helper()
...
func (mr *MockCredentialsRepositoryMockRecorder) ChangePassword(ctx, credentials any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ChangePassword", reflect.TypeOf((*MockCredentialsRepository)(nil).ChangePassword), ctx, credentials)
}
