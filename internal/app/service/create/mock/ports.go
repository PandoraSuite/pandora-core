...
// Source: internal/app/service/create/ports.go
//
// Generated by this command:
//
//	mockgen -source=internal/app/service/create/ports.go -destination=internal/app/service/create/mock/ports.go -package=mock
//
...
func (m *MockServiceRepository) Create(ctx context.Context, service *entities.Service) errors.Error {
	m.ctrl.T.Helper()
