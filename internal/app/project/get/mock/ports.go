...
// Source: internal/app/project/get/ports.go
//
// Generated by this command:
//
//	mockgen -source=internal/app/project/get/ports.go -destination=internal/app/project/get/mock/ports.go -package=mock
//
...
func (m *MockProjectRepository) GetByID(ctx context.Context, id int) (*entities.Project, errors.Error) {
	m.ctrl.T.Helper()
