...
type ClientFilter struct {
	Type enums.ClientType `form:"type" enums:"developer,organization"`
}
...
type ClientCreate struct {
	Type  enums.ClientType `json:"type" binding:"required" enums:"developer,organization"`
...
type ClientUpdate struct {
	Type  enums.ClientType `json:"type" enums:"developer,organization"`
