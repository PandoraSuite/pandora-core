...
type RequestFilter struct {
	...
	ExecutionStatus enums.RequestExecutionStatus `form:"execution_status" enums:"success,forwarded,client_error,service_error,unauthorized,quota_exceeded"`
}
...
type RequestResponse struct {
	...
	ExecutionStatus enums.RequestExecutionStatus `json:"execution_status" enums:"success,forwarded,client_error,service_error,unauthorized,quota_exceeded"`
