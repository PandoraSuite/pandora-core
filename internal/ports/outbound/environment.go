...
type EnvironmentPort interface {
	...
	FindServiceByID(ctx context.Context, id, serviceID int) (*entities.EnvironmentService, *errors.Error)
	...
	HasInfiniteEnvironmentService(ctx context.Context, projectID, serviceID int) (bool, *errors.Error)
